...
export default function DashboardLayout({ children, currentPath }: Props) {
  ...
  return (
    <div className="flex min-h-[calc(100dvh-4rem)]">
      <aside className="hidden w-64 shrink-0 border-r border-warm-200 bg-cream-50 p-4 dark:border-warm-800 dark:bg-warm-700 md:block">
        ...
        <div className="mt-8 border-t border-warm-200 pt-4 dark:border-warm-800">
          <form action="/api/auth/logout" method="POST">
            <button type="submit" className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-warm-600 hover:bg-cream-100 hover:text-warm-900 dark:text-warm-400 dark:hover:bg-warm-800 dark:hover:text-warm-100">
              <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="flex-1">
        ...
        {dbStatus === "checking" && (
          <div className="flex items-center gap-2 border-b border-warm-200 bg-cream-50 px-6 py-2 text-xs text-warm-500 dark:border-warm-800 dark:bg-warm-700">
